...
<button type="button" class="bg-secondary text-white px-6 py-2 rounded-xl font-title-md text-body-sm hover:opacity-90 active:scale-95 transition-all flex items-center gap-2">
...
<section class="flex-1 overflow-hidden flex flex-col bg-surface-container-lowest">
<!-- Board Header -->
<div class="px-gutter py-6 flex items-center justify-between">
<div>
<h2 class="font-headline-lg text-title-md text-primary">Senior Product Designer Pipeline</h2>
<p class="font-body-sm text-body-sm text-on-surface-variant">24 total applicants across 5 stages</p>
</div>
<div class="flex items-center gap-2 bg-surface-container border border-outline-variant p-1 rounded-xl">
<button class="px-4 py-1.5 rounded-lg bg-white shadow-sm font-title-md text-body-sm text-secondary">Board</button>
<button class="px-4 py-1.5 rounded-lg font-title-md text-body-sm text-on-surface-variant hover:bg-white/50 transition-all">List</button>
</div>
</div>
...
<!-- Column: Applied -->
<div class="kanban-column flex flex-col h-full bg-surface-container-low/50 rounded-2xl border border-outline-variant/30">
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-title-md text-body-sm font-bold text-primary">Applied</span>
<span class="bg-surface-variant text-on-surface-variant px-2 py-0.5 rounded-full text-[10px] font-bold">8</span>
</div>
<button class="material-symbols-outlined text-outline hover:text-primary transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
<!-- Card 1 -->
<div class="bg-white p-card-padding rounded-xl border border-outline-variant shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.05)] hover:shadow-md transition-all cursor-grab active:cursor-grabbing border-l-4 border-l-secondary/20">
...
<div class="flex items-center text-secondary font-bold text-body-sm">
<span>98%</span>
...
<span class="bg-surface-container px-2 py-0.5 rounded-md text-[10px] font-medium">Design Systems</span>
<span class="bg-surface-container px-2 py-0.5 rounded-md text-[10px] font-medium">React</span>
</div>
<div class="flex justify-between items-center pt-3 border-t border-outline-variant/30">
<div class="flex -space-x-2">
<div class="w-6 h-6 rounded-full border-2 border-white bg-blue-100 flex items-center justify-center text-[10px] font-bold">MC</div>
</div>
...
<!-- Card 2 -->
<div class="bg-white p-card-padding rounded-xl border border-outline-variant shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.05)] hover:shadow-md transition-all cursor-grab border-l-4 border-l-secondary/20">
<div class="flex justify-between items-start mb-3">
<div class="flex items-center gap-3">
<div class="w-10 h-10 rounded-full bg-surface-variant flex items-center justify-center font-bold text-on-surface-variant">AM</div>
<div>
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-title-md text-body-sm font-bold text-primary">Phone Screen</span>
<span class="bg-surface-variant text-on-surface-variant px-2 py-0.5 rounded-full text-[10px] font-bold">4</span>
</div>
<button class="material-symbols-outlined text-outline hover:text-primary transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
...
<span class="text-[11px] text-outline">15m duration</span>
</div>
</div>
</div>
</div>
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-title-md text-body-sm font-bold text-primary">Interview</span>
<span class="bg-surface-variant text-on-surface-variant px-2 py-0.5 rounded-full text-[10px] font-bold">5</span>
</div>
<button class="material-symbols-outlined text-outline hover:text-primary transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
<!-- Card 4 -->
<div class="bg-white p-card-padding rounded-xl border border-outline-variant shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.05)] hover:shadow-md transition-all cursor-grab border-l-4 border-l-indigo-500">
<div class="flex justify-between items-start mb-3">
<div class="flex items-center gap-3">
...
<span class="text-[11px] text-outline">Round 2 scheduled</span>
</div>
</div>
</div>
</div>
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-title-md text-body-sm font-bold text-primary">Technical</span>
<span class="bg-surface-variant text-on-surface-variant px-2 py-0.5 rounded-full text-[10px] font-bold">3</span>
</div>
<button class="material-symbols-outlined text-outline hover:text-primary transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
<!-- Card 5 -->
<div class="bg-white p-card-padding rounded-xl border border-outline-variant shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.05)] hover:shadow-md transition-all cursor-grab border-l-4 border-l-purple-500">
<div class="flex justify-between items-start mb-3">
<div class="flex items-center gap-3">
...
<span class="text-[10px] text-on-surface-variant bg-white px-1.5 py-0.5 rounded shadow-sm">Reviewing</span>
</div>
</div>
</div>
</div>
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-title-md text-body-sm font-bold text-primary">Offer</span>
<span class="bg-surface-variant text-on-surface-variant px-2 py-0.5 rounded-full text-[10px] font-bold">4</span>
</div>
<button class="material-symbols-outlined text-outline hover:text-primary transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
<!-- Card 6 -->
<div class="bg-white p-card-padding rounded-xl border border-outline-variant shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.05)] hover:shadow-md transition-all cursor-grab border-l-4 border-l-secondary">
<div class="flex justify-between items-start mb-3">
<div class="flex items-center gap-3">
...
<footer class="w-full py-8 bg-surface dark:bg-inverse-surface border-t border-outline-variant dark:border-outline mt-auto">
<div class="flex flex-col md:flex-row justify-between items-center px-container-margin max-w-7xl mx-auto">
<p class="font-body-sm text-body-sm text-on-surface-variant dark:text-surface-variant">© 2024 Elements HR Services. All rights reserved.</p>
<div class="flex gap-8 mt-4 md:mt-0">
<a class="font-label-caps text-label-caps text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-on-primary-fixed transition-opacity opacity-80 hover:opacity-100" href="{{ route('landing') }}">Privacy Policy</a>
<a class="font-label-caps text-label-caps text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-on-primary-fixed transition-opacity opacity-80 hover:opacity-100" href="{{ route('landing') }}">Terms of Service</a>
<a class="font-label-caps text-label-caps text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-on-primary-fixed transition-opacity opacity-80 hover:opacity-100" href="{{ route('login') }}">Contact Support</a>
</div>
</div>
</footer>
</div>
