...
<section class="flex-1 overflow-hidden flex flex-col" style="background: #0F172A;">
<!-- Board Header -->
<div class="px-6 py-5 flex flex-wrap items-center justify-between gap-4 border-b border-[#1E293B]">
<div>
    <div class="flex items-center gap-2 mb-1">
        <span class="badge-violet text-[10px]">Kanban Board</span>
    </div>
    <h2 class="text-[20px] font-bold text-[#E2E8F0]">Senior Product Designer Pipeline</h2>
    <p class="text-[13px] text-[#64748B]">24 total applicants across 5 stages</p>
</div>
<div class="flex items-center gap-2 glass-card p-1 rounded-xl">
    <button class="px-4 py-1.5 rounded-lg bg-[#263248] text-[#8B5CF6] text-[12px] font-semibold">Board</button>
    <button class="px-4 py-1.5 rounded-lg text-[#64748B] text-[12px] font-semibold hover:bg-[#1E293B] transition-all">List</button>
</div>
</div>
...
<span class="font-semibold text-[13px] text-[#E2E8F0]">Applied</span>
<span class="bg-[#334155] text-[#94A3B8] px-2 py-0.5 rounded-full text-[10px] font-bold">8</span>
</div>
<button class="material-symbols-outlined text-[#64748B] hover:text-[#E2E8F0] transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
<!-- Card 1 -->
<div class="kanban-card p-3 cursor-grab active:cursor-grabbing border-l-4 border-l-[#8B5CF6]/40">
...
<p class="text-[#64748B] text-[12px]">Lead Designer @@ Figma</p>
</div>
</div>
<div class="flex flex-col items-end">
<div class="flex items-center text-[#8B5CF6] font-bold text-[12px]">
<span>98%</span>
...
<span class="px-2 py-0.5 rounded-md text-[10px] font-medium bg-[#1E1B4B] text-[#C4B5FD]">Design Systems</span>
<span class="px-2 py-0.5 rounded-md text-[10px] font-medium bg-[#1E1B4B] text-[#C4B5FD]">React</span>
</div>
<div class="flex justify-between items-center pt-3 border-t border-[#334155]/50">
<div class="flex -space-x-2">
<div class="w-6 h-6 rounded-full border-2 border-white bg-[#1E1B4B] flex items-center justify-center text-[10px] font-bold text-[#C4B5FD]">MC</div>
</div>
...
<!-- Card 2 -->
<div class="kanban-card p-3 cursor-grab border-l-4 border-l-[#8B5CF6]/40">
<div class="flex justify-between items-start mb-3">
<div class="flex items-center gap-3">
<div class="w-10 h-10 rounded-full bg-[#263248] flex items-center justify-center font-bold text-[#94A3B8]">AM</div>
<div>
<p class="font-title-md text-body-sm font-bold">Alex Martinez</p>
<p class="text-[#64748B] text-[12px]">Senior UX @@ Stripe</p>
</div>
</div>
<div class="flex flex-col items-end">
<div class="flex items-center text-[#8B5CF6] font-bold text-[12px]">
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-semibold text-[13px] text-[#E2E8F0]">Phone Screen</span>
<span class="bg-[#334155] text-[#94A3B8] px-2 py-0.5 rounded-full text-[10px] font-bold">4</span>
</div>
<button class="material-symbols-outlined text-[#64748B] hover:text-[#E2E8F0] transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
...
<p class="text-[#64748B] text-[12px]">UI Lead @@ Airbnb</p>
</div>
</div>
<div class="flex flex-col items-end">
<div class="flex items-center text-[#8B5CF6] font-bold text-[12px]">
...
<span class="text-[11px] text-[#64748B]">15m duration</span>
</div>
</div>
</div>
</div>
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-semibold text-[13px] text-[#E2E8F0]">Interview</span>
<span class="bg-[#334155] text-[#94A3B8] px-2 py-0.5 rounded-full text-[10px] font-bold">5</span>
</div>
<button class="material-symbols-outlined text-[#64748B] hover:text-[#E2E8F0] transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
...
<p class="text-[#64748B] text-[12px]">Senior Designer @@ Uber</p>
</div>
</div>
<div class="flex flex-col items-end">
<div class="flex items-center text-[#8B5CF6] font-bold text-[12px]">
...
<span class="text-[11px] text-[#64748B]">Round 2 scheduled</span>
</div>
</div>
</div>
</div>
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-semibold text-[13px] text-[#E2E8F0]">Technical</span>
<span class="bg-[#334155] text-[#94A3B8] px-2 py-0.5 rounded-full text-[10px] font-bold">3</span>
</div>
<button class="material-symbols-outlined text-[#64748B] hover:text-[#E2E8F0] transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
...
<p class="text-[#64748B] text-[12px]">Design Ops @@ Adobe</p>
</div>
</div>
<div class="flex flex-col items-end">
<div class="flex items-center text-[#8B5CF6] font-bold text-[12px]">
...
<span class="text-[10px] text-[#94A3B8] bg-[#1E293B] px-1.5 py-0.5 rounded border border-[#334155]">Reviewing</span>
</div>
</div>
</div>
</div>
...
<div class="p-4 flex items-center justify-between">
<div class="flex items-center gap-2">
<span class="font-semibold text-[13px] text-[#E2E8F0]">Offer</span>
<span class="bg-[#334155] text-[#94A3B8] px-2 py-0.5 rounded-full text-[10px] font-bold">4</span>
</div>
<button class="material-symbols-outlined text-[#64748B] hover:text-[#E2E8F0] transition-colors" data-icon="more_horiz">more_horiz</button>
</div>
<div class="flex-1 overflow-y-auto px-3 pb-4 space-y-3 custom-scrollbar">
<!-- Card 6 -->
<div class="kanban-card p-3 cursor-grab border-l-4 border-l-[#8B5CF6]">
<div class="flex justify-between items-start mb-3">
<div class="flex items-center gap-3">
...
<p class="text-[#64748B] text-[12px]">Principal @@ Spotify</p>
</div>
</div>
<div class="flex flex-col items-end">
<div class="flex items-center text-[#8B5CF6] font-bold text-[12px]">
