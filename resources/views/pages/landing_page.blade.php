...
<a href="{{ route('user.jobs.recommendations') }}" class="px-8 py-4 bg-white text-secondary font-title-md text-title-md rounded-xl hover:shadow-lg transition-all active:scale-[0.98] text-center">
                        Find your Dream Job
                    </a>
<a href="{{ route('hr.dashboard') }}" class="px-8 py-4 border border-white/30 text-white font-title-md text-title-md rounded-xl hover:bg-white/10 backdrop-blur-md transition-all active:scale-[0.98] text-center">
                        Hire Top Talent
                    </a>
</div>
</div>
