...
<main class="flex w-full min-h-screen">
    ...
    <section class="w-full lg:w-[45%] flex items-center justify-center p-8 bg-background">
        <div class="w-full max-w-[420px] animate-fade-in">
            ...
            <div class="mb-8">
                <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-[13px] text-on-surface-variant hover:text-secondary transition-colors mb-6">
                    <span class="material-symbols-outlined text-[16px]">arrow_back</span>
                    Back to Login
                </a>
                <h2 class="text-[28px] font-bold text-on-surface mb-2">Forgot Password?</h2>
                <p class="text-[14px] text-on-surface-variant">Enter your email address and we'll send you a reset link.</p>
            </div>
            ...
            <div class="glass-card p-8">
                <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                    ...
                    <p class="text-center text-[13px] text-on-surface-variant">
                        ...
                        <a href="{{ route('login') }}" class="text-secondary hover:text-secondary transition-colors font-medium">Sign In</a>
                    </p>
                </form>
            </div>
